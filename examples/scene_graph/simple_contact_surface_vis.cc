...
DEFINE_double(hybrid, false, "Set to true to run hybrid hydroelastic");
...
class ContactResultMaker final : public LeafSystem<double> {
 public:
  ...
  ContactResultMaker(bool use_strict_hydro = true)
...
int do_main() {
  ...
  scene_graph.AssignRole(source_id, can_id, ProximityProperties());
  scene_graph.AssignRole(source_id, can_id, illus_props);
