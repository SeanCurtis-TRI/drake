...
/** @anchor sdf_contact_material
 ...
 | drake:slab_thickness             | hydroelastic | slab_thickness            | Required for declaring a soft hydroelastic representation of a <plane> geometry. Ignored for other geometry types.               |
