...
enum class ContactModel {
  ...
  /// geometry::SpatialQueryObject:ComputeContactSurfacesWithFallback for more
  /// details.
...
/// SceneGraph::get_spatial_query_output_port().
...
/// 4. Connect SceneGraph::get_spatial_query_output_port() to
...
class MultibodyPlant : public internal::MultibodyTreeSystem<T> {
 public:
  ...
  /// queries on a SceneGraph. See SceneGraph::get_spatial_query_output_port().
  ...
  /// geometry::SceneGraphInspector and geometry::SpatialQueryObject (for its
