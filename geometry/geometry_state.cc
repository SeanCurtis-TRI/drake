...
template <typename T>
void GeometryState<T>::RenderColorImage(
    const render::CameraProperties& camera, const math::RigidTransformd& X_WC,
    systems::sensors::ImageRgba8U* color_image_out, bool show_window) const {
