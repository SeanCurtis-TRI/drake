...
const char* const kCompliance = "compliance";
...
void AddRigidHydroelasticProperties(ProximityProperties* properties) {
  ...
  // Downstream consumers (ProximityEngine) will determine if this is
  // sufficient.
  properties->AddProperty(internal::kHydroGroup, internal::kCompliance,
