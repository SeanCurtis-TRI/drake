...
template <typename T>
void RenderQueryObject<T>::RenderColorImage(const CameraProperties& camera,
...
template <typename T>
void RenderQueryObject<T>::RenderDepthImage(const DepthCameraProperties& camera,
                                      FrameId parent_frame,
                                      const RigidTransformd& X_PC,
...
template <typename T>
void RenderQueryObject<T>::RenderLabelImage(const CameraProperties& camera,
                                      FrameId parent_frame,
                                      const RigidTransformd& X_PC,
                                      bool show_window,
