...
/** A variant of a QueryObject which renders the SceneGraph world -- color,
 ...
 that of QueryObject, acquiring a reference to a %RenderQueryObject, working
...
class RenderQueryObject : public QueryObject<T> {
 public:
  ...
  /** Constructs a default RenderQueryObject (all pointers are null). */
  RenderQueryObject() = default;
  ...
  /**
   ...
   extrinsic and intrinsic properties and %RenderQueryObject renders into the
   provided image.
