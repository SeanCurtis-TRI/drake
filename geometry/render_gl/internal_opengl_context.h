 ...
 public:
  /* Copy constructor. Provided solely so RenderEngineGl can maintain a
   ...
   - Copying an %OpenGlContext is distinct from creating a new instance in that
     all of the OpenGl objects (buffers, textures, vertex arrays, display lists,
     etc.) available to `other` will also be available to the copy. New
     instances have no OpenGl objects. */
