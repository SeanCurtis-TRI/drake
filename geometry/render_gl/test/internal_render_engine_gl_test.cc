...
class RenderEngineGlTest : public ::testing::Test {
 ...
 protected:
  ...
  // TODO(SeanCurtis-TRI): Refactor this functionality between here and the
  // RenderEngineVtk tests so they share code.
...
// after it. This should be the case whether the transparent geometry has a
// texture or not.
TEST_F(RenderEngineGlTest, FullyTransparentGeometryDoesNotOccludeColor) {
  Init(X_WR_);

  // Exercises the "color" shader.
