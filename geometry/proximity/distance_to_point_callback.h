...
struct CallbackData {
  /* Constructs the fully-specified callback data. The values are as described
   ...
   @param mesh_sdf_cache_in The cache for mesh SDF data. Aliased.
  ...
  const MeshSdfCache& mesh_sdf_cache;
